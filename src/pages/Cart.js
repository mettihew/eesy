...
<ButtonGroup>
  ...
  return (
    <div className="container-fluid align-items-start" id="d-f" style={{justifyContent:'space-between', flexWrap:'wrap'}}>
      ...
      {map}
      <div className="border border-danger rounded-pill text-center p-2" style={{position: "sticky"}}> <Link to="/order" id="no-a" className="text-warning h3">Continue to order</Link></div>
      </div>
    }
