...
function Favorite() {
  ...
  return (
      ...
      <div className="products-items" >
        ...
        {productState?.length === 0 && <div id="j-c" className="col"> <h2>Favorite is empty</h2> <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSwZBISiHxiUPWBHNJZBGjWkz_9B1VyYnAEFg&s" width={"100px"} alt="loading" /> </div> }
